...
public class PredEval {
	 ...
	 */
	public static boolean Eval(CondExpr p[], Tuple t1, Tuple t2,
			AttrType in1[], AttrType in2[]) throws IOException, UnknowAttrType,
		...
		while (p[i] != null) {
			...
			while (temp_ptr != null) {
				...
				case AttrType.attrDesc:
					value.setHdr((short) 1, val_type, null);
					value.setDescFld(1, temp_ptr.operand1.attrDesc);
					tuple1 = value;
