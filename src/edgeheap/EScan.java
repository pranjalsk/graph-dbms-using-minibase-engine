...
public class EScan implements GlobalConst{
	   ...
	   IOException
  {
    ...
    try {
      recptredge = datapage.getRecord(eid);
    }
  ...
  //    System.err.println("SCAN: Error in Scan" + e);
    ...
    usereid = datapage.nextRecord(eid);
    if(usereid == null) nextUserStatus = false;
   ...
   * Also returns the EID of the (new) current record.
   */
	   ...
	   IOException
  {
    ...
    if (datapage == null)
    	...
    	nexteid = datapage.nextRecord(eid);
