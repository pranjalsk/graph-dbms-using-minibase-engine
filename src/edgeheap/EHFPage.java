...
public class EHFPage extends Page implements ConstSlot, GlobalConst {
	 ...
	 *                recLen, RID& rid)
	 */
	public EID insertRecord(byte[] record) throws IOException {
		EID eid = new EID();
	 ...
	 */
	public void deleteRecord(EID eid) throws IOException,
	 ...
	 * 
	 */
	public EID firstRecord() throws IOException {
		EID eid = new EID();
	 ...
	 *                nextRid)
	 */
	public EID nextRecord(EID curEid) throws IOException {
		EID eid = new EID();
		slotCnt = Convert.getShortValue(SLOT_CNT, data);
	 ...
	 * @see Tuple
	 */
	public Edge getRecord(EID eid) throws IOException,
			InvalidSlotNumberException {
		short recLen;
		short offset;
		byte[] record;
	 ...
	 * @see Tuple
	 */
	public Edge returnRecord(EID eid) throws IOException,
			InvalidSlotNumberException {
		short recLen;
		short offset;
		PageId pageNo = new PageId();
