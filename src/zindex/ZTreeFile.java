...
/**
 * This is the main definition of class ZTreeFile, which derives from 
...
public class ZTreeFile extends IndexFile implements GlobalConst {
	 ...
	 */
	public ZTreeFile(String zTBFile) throws GetFileEntryException, ConstructPageException, AddFileEntryException, IOException, PinPageException {
...
/** insert record with the given key and nid
   ...
   */ 
	...
	/**
	 * creates a scan that returns the descriptors that lies 
	 * within the given distance range from the target descriptor
	 * @param target
	 * @param distance
