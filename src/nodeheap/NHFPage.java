...
public class NHFPage extends Page implements ConstSlot, GlobalConst {
	 ...
	 *                recLen, RID& rid)
	 */
	public NID insertRecord(byte[] record) throws IOException {
		NID nid = new NID();
	 ...
	 * @see Tuple
	 */
	public Node getRecord(NID nid) throws IOException,
			InvalidSlotNumberException {
		short recLen;
		short offset;
		byte[] record;
	 ...
	 * @see Tuple
	 */
	public Node returnRecord(NID nid) throws IOException,
			InvalidSlotNumberException {
		short recLen;
		short offset;
		PageId pageNo = new PageId();
